// use model::{AccountUpdateEvent, KlineEvent, OrderTradeEvent, TradesEvent};
// use errors::*;
// use url::Url;
// use std::fmt;
...
// impl fmt::Debug for WebSockets {
//     fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
//         write!(
//             f,
//             "WebSockets {{ has socket: {}, has user_stream_handler: {}, has market_handler: {}, has kline_handler: {} }}",
//             self.socket.is_some(),
//             self.user_stream_handler.is_some(),
//             self.market_handler.is_some(),
//             self.kline_handler.is_some()
//         )
//     }
// }
